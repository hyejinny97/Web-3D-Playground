...
class FabricMaterialHelper implements FabricMaterialHelperType {
  private controlUIGroupName = "MeshStandardMaterial";
  private _args: FabricMaterialHelperType["args"];
  private _material = new THREE.MeshStandardMaterial();
  textures: Partial<Record<FabricTextureType, THREE.Texture>> = {};
  ...
  async loadTextures(textureLoad?: TextureLoadingType) {
    ...
    await Promise.allSettled(
      Object.keys(FABRIC_TEXTURES).map(async (key) => {
        const name = key as FabricTextureType;
        const { url, colorSpace } = FABRIC_TEXTURES[name];
    ...
    this.controlUI.add(this.controlUIGroupName, [
      {
        type: "texture",
        label: "aoMap",
        imageUrl: FABRIC_TEXTURES.aoMap.url,
      ...
      },
      {
        ...
        imageUrl: FABRIC_TEXTURES.displacementMap.url,
      ...
      },
      {
        type: "texture",
        label: "map",
        imageUrl: FABRIC_TEXTURES.map.url,
      ...
      },
      {
        type: "texture",
        label: "normalMap",
        imageUrl: FABRIC_TEXTURES.normalMap.url,
      ...
      },
      {
        type: "texture",
        label: "metalnessMap",
        imageUrl: FABRIC_TEXTURES.metalnessMap.url,
      ...
      },
      {
        type: "texture",
        label: "roughnessMap",
        imageUrl: FABRIC_TEXTURES.roughnessMap.url,
...
export default FabricMaterialHelper;
