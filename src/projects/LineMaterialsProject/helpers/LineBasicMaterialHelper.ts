...
import type { LineBasicMaterialHelperType } from "../LineMaterialsProject.types";
...
class LineBasicMaterialHelper implements LineBasicMaterialHelperType {
  private controlUIGroupName = "LineBasicMaterial";
  private _args: LineBasicMaterialHelperType["args"];
  ...
  update(properties: THREE.LineBasicMaterialParameters) {
...
export default LineBasicMaterialHelper;
