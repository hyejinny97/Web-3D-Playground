...
import EdgesGeometryProject from "@/projects/EdgesGeometryProject";
...
const EdgesGeometryCanvas = () => {
  const containerRef = useRef<HTMLDivElement>(null);
  const projectRef = useRef<EdgesGeometryProject>(undefined);
  ...
  useLayoutEffect(() => {
    ...
    const project = new EdgesGeometryProject({
      canvasEl,
...
export default EdgesGeometryCanvas;
