...
import LineMaterialsProject from "@/projects/LineMaterialsProject";
...
const LineMaterialsCanvas = () => {
  const containerRef = useRef<HTMLDivElement>(null);
  const projectRef = useRef<LineMaterialsProject>(undefined);
  ...
  useLayoutEffect(() => {
    ...
    const project = new LineMaterialsProject({
      canvasEl,
...
export default LineMaterialsCanvas;
