...
import LatheGeometryProject from "@/projects/LatheGeometryProject";
import type { Project } from "@/types/project";
import useControl from "@/hooks/useControl";

const LatheGeometryCanvas = () => {
  ...
  useLayoutEffect(() => {
    ...
    const project: Project = new LatheGeometryProject({
      canvasEl,
...
export default LatheGeometryCanvas;
