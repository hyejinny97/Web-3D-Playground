...
import MeshMaterialsProject from "@/projects/MeshMaterialsProject";
...
const MeshMaterialsCanvas = () => {
  const containerRef = useRef<HTMLDivElement>(null);
  const projectRef = useRef<MeshMaterialsProject>(undefined);
  ...
  useLayoutEffect(() => {
    ...
    const project = new MeshMaterialsProject({
      canvasEl,
...
export default MeshMaterialsCanvas;
