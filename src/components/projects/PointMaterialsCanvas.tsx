...
import PointMaterialsProject from "@/projects/PointMaterialsProject";
import type { Project } from "@/types/project";
import useControl from "@/hooks/useControl";

const PointMaterialsCanvas = () => {
  ...
  useLayoutEffect(() => {
    ...
    const project: Project = new PointMaterialsProject({
      canvasEl,
...
export default PointMaterialsCanvas;
