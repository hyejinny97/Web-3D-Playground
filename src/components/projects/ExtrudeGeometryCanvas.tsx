...
import ExtrudeGeometryProject from "@/projects/ExtrudeGeometryProject";
...
const ExtrudeGeometryCanvas = () => {
  const containerRef = useRef<HTMLDivElement>(null);
  const projectRef = useRef<ExtrudeGeometryProject>(undefined);
  ...
  useLayoutEffect(() => {
    ...
    const project = new ExtrudeGeometryProject({
      canvasEl,
...
export default ExtrudeGeometryCanvas;
