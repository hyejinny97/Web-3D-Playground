...
import BasicTransformProject from "@/projects/BasicTransformProject";
...
const BasicTransformCanvas = () => {
  ...
  useLayoutEffect(() => {
    ...
    const project: Project = new BasicTransformProject({
      canvasEl,
...
export default BasicTransformCanvas;
